...
Invoke-Executable az storage file upload-batch --account-name $StorageAccountName --connection-string $StorageAccountConnectionString --destination $FileshareName --destination-path $DestinationPath --source $SourceFilePath
