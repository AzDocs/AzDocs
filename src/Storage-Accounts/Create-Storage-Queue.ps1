...
$connectionString = (Invoke-Executable az storage account show-connection-string -n $BlobStorageAccountName -g $ResourceGroupName | ConvertFrom-Json).connectionString
