...
function Add-AccessRestriction
{
    ...
    Confirm-CIDRorSubnetResourceId -CIDR $CIDR -SubnetResourceId $SubnetResourceId
...
{  
    ...
    if ($AutoGeneratedAccessRestrictionRuleName)
    {
        if ($CIDR)
        {
            ...
            {
                Write-Host "Access restriction for type $SecurityRestrictionObjectName does not exist for $CIDR. Creating."
                return $false
            }
        }
        elseif ($SubnetResourceId)
        {
            ...
            {
                Write-Host "Access restriction for type $SecurityRestrictionObjectName already exists for $SubnetResourceId, continueing"
                return $true
            }
            else
            {
                Write-Host "Access restriction for type $SecurityRestrictionObjectName does not exist for $SubnetResourceId. Creating."
                return $false
            }
        }
    }
    ...
    if ($CIDR)
    {
        ...
        {
            Write-Host "Access restriction for type $SecurityRestrictionObjectName already exists for $AccessRestrictionRuleName and $CIDR, continueing"
            return $true
        }
        else
        {
            Write-Host "Access restriction for type $SecurityRestrictionObjectName does not exist for $AccessRestrictionRuleName and $CIDR. Creating."
            return $false
        }
    }
    elseif ($SubnetResourceId)
    {
        ...
        {
            Write-Host "Access restriction for type $SecurityRestrictionObjectName already exists for $AccessRestrictionRuleName and $SubnetResourceId, continueing"
            return $true
        }
        else
        {
            Write-Host "Access restriction for type $SecurityRestrictionObjectName does not exist for $AccessRestrictionRuleName and $SubnetResourceId. Creating."
            return $false
        }
    }
