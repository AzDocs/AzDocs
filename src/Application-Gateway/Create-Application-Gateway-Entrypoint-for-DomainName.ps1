...
try
{
    ...
    -sharedServicesKeyvaultName $sharedServicesKeyvaultName -certificatePassword $certificatePassword -backendDomainname $backendDomainname -healthProbePath $healthProbePath -healthProbeInterval $healthProbeInterval `
