...
Invoke-Executable az functionapp config set --ids $functionAppId --number-of-workers $FunctionAppNumberOfInstances --always-on $FunctionAppAlwaysOn --ftps-state Disabled
