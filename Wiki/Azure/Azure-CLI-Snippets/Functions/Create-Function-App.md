...
| FunctionAppMinimalTlsVersion | <input type="checkbox"> | <input type="checkbox"> | `1.2` | Set the TLS Version for the function app. Defaults to 1.2 |
