...
| SqlServerAzureAdAdminObjectId    | <input type="checkbox">         | `808380fc-c267-4e74-a3b3-d9b57ba39800`                                                                                                          | You will need to pass this if you want to use Azure AD authentication. Use in combination with the `SqlServerAzureAdAdminDisplayName` parameter. Pass the `object id` of the Azure AD user to make admin. You can fetch this `object id` using the `az ad user show` command. |
| SqlServerAzureAdAdminDisplayName | <input type="checkbox">         | `myuser@company.com`                                                                                                                            | You will need to pass this if you want to use Azure AD authentication. Use in combination with the `SqlServerAzureAdAdminObjectId` parameter. The name/email of the Azure AD user to make SQL Server Admin.                                                                   |
