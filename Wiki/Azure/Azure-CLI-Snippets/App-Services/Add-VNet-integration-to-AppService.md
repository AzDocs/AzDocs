...
| AppServiceVnetIntegrationVnetResourceGroupName | <input type="checkbox"> | `My-Shared-RG-dev`| OPTIONAL: The resourcegroup of the VNet if it's in a different resourcegroup than the webapp. |
