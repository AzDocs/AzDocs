...
| AccessRestrictionRuleName | <input type="checkbox"> | `company hq` | OPTIONAL: You can override the name for this accessrule. If you leave this empty, the CIDRToWhitelist will be used for the naming (automatically). We recommend to leave this empty for ephemeral whitelists like Azure DevOps Hosted Agent ip's. |
