...
This snippet will only handle role assignments scoped to resources and nested resources. For broader assignment, you may want to call the [Create-ScopedRoleAssignment](../../../../src/AzDocs.Common/public/Create-ScopedRoleAssignment.ps1) function directly.
