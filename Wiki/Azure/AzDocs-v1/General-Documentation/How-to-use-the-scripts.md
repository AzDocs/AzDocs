...
4. Go to pipelines and create a `New Pipeline` in the [Azure Documentations team project](/Azure/AzDocs-v1/General-Documentation/Setup-Azure-DevOps-and-GIT#setup-azure-devops-%26-git).
...
2.  The AzDocs TeamProject (you can find how to setup under [Setup Azure DevOps & GIT](/Azure/AzDocs-v1/General-Documentation/Setup-Azure-DevOps-and-GIT#setup-azure-devops-%26-git)).
