...
| DisableClientAffinity | <input type="checkbox"> | <input type="checkbox"> | `$false` | Improve performance of your stateless app by turning Affinity Cookie off, stateful apps should keep this setting on for compatibility. |
