...
## YAML Pipelines
To achieve this in YAML pipelines, you can simply delete a resourcegroup in a YAML pipeline and add the following template to run it every workday (monday to friday) 
